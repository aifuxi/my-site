        ...
        <div className="overflow-hidden w-72 rounded-2xl">
          <div className="overflow-hidden shadow-xl card bg-base-100 rounded-2xl">
            ...
            <div className="py-2 text-center">
              <Link href="/">
                <a className="block text-2xl font-bold text-gray-800">F西</a>
              </Link>
              <span className="text-sm text-gray-700">今日无事，勾栏听曲</span>
            </div>

            <div className="flex w-full relative after:content-[''] after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:h-[1px] after:w-11/12 after:bg-gray-100 pb-4">
              <div className="flex flex-col items-center justify-center flex-1 relative after:content-[''] after:absolute after:right-0 after:top-1/2 after:-translate-y-1/2 after:w-[1px] after:h-1/2 after:bg-gray-100">
                <span className="text-2xl font-medium">17</span>
                <span className="text-xs text-gray-400">专栏数</span>
              </div>
              <div className="flex flex-col items-center justify-center flex-1 relative after:content-[''] after:absolute after:right-0 after:top-1/2 after:-translate-y-1/2 after:w-[1px] after:h-1/2 after:bg-gray-100">
                <span className="text-2xl font-medium">17</span>
                <span className="text-xs text-gray-400">专栏数</span>
